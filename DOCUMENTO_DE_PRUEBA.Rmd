...
```{r grafico LIQUIDEZ CORRIENTE, echo=TRUE, fig.width=9, fig.align='left', warning=FALSE, message=FALSE}
...
```{r grafico ENDEUDAMIENTO DEL ACTIVO, echo=TRUE, fig.align='left', message=FALSE, warning=FALSE, fig.width=9}
...
```{r grafico ENDEUDAMIENTO PATRIMONIAL, echo=TRUE, fig.align='left', message=FALSE, warning=FALSE, fig.width=9}
...
```{r grafico ENDEUDAMIENTO DEL ACTIVO FIJO, echo=TRUE, fig.align='left', message=FALSE, warning=FALSE, fig.width=9}
...
```{r grafico APALANCAMIENTO, echo=TRUE, fig.align='left', message=FALSE, warning=FALSE, fig.width=9}
...
```{r GRAFICO_TOP_EMPRESAS, echo=TRUE, out.width='75%', fig.align='center', fig.width=7}
